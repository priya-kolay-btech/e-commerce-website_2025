...
const logout=()=>{
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to='/'><img src={assets.forever_icon} className='w-36' alt=""/></Link>
...
{/*-------Dropdown menu-------- */}
   ...
   <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
        <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-150 text-gray-500 rounded'>
...
<img onClick={()=>setVisible(true)}   src={assets.blue_menu} className='w-5 cursor-pointer sm:hidden' alt=""/>
