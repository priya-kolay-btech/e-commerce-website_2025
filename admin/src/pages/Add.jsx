...
console.log("JWT Token in Add component:", token); 
...
<div className='flex flex-col sm:flex-row ga2 w-full sm:gap-8'>
...
//   // Upload a single image, returns URL of uploaded image
...
//       if (image1) imageUrls.push(await uploadImage(image1))
//       if (image2) imageUrls.push(await uploadImage(image2))
//       if (image3) imageUrls.push(await uploadImage(image3))
//       if (image4) imageUrls.push(await uploadImage(image4))
